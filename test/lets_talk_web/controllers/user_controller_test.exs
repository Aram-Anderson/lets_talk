defmodule LetsTalkWeb.UserControllerTest do
  use LetsTalkWeb.ConnCase

  alias LetsTalk.Accounts

  @create_attrs %{bio: "some bio", email: "some email", first_name: "some first_name", is_admin: true, last_name: "some last_name", password: "some password", username: "some username"}
